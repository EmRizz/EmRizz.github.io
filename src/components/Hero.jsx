  ...
  return (
    <section className='relative w-full h-[120vh] mx-auto' >
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl flex flex-row items-start gap-5`}>
        ...
        <div> 
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-[#915eff]'>M. Rizki Kurnia Ramadhan</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web applications <br className='sm:block hidden' />
            Front-End based on React.JS <br className='sm:block hidden' /> 
            & Back-End based on Node.JS
          </p>
        </div>
      </div>
